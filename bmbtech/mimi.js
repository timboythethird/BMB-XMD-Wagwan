const { zokou } = require('../framework/zokou'); const { addOrUpdateDataInAlive, getDataFromAlive } = require('../bdd/alive'); const moment = require("moment-timezone"); const path = require("path"); const fs = require("fs"); const s = require(__dirname + "/../set");
...
if (!arg || !arg[0]) {
        ...
        if (data) {
            ...
            try {
                ...
                await sendForwardedText(zk, dest, ms, "🔥 PopkidGlx Newsletter 🔥", sender);
