const { zokou } = require('../framework/zokou'); const { addOrUpdateDataInAlive, getDataFromAlive } = require('../bdd/alive'); const moment = require("moment-timezone"); const s = require(__dirname + "/../set"); const fs = require("fs"); const path = require("path");

async function sendForwardedText(zk, dest, ms, text, sender) { await zk.sendMessage(dest, { text, contextInfo: { mentionedJid: [sender], forwardingScore: 999, isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: "120363290715861418@newsletter", newsletterName: "PopkidGlx", serverMessageId: 143, }, }, }, { quoted: ms }); }
...
if (!arg || !arg[0]) {
        ...
        if (data) {
            ...
            try {
                ...
                repondre(`B.M.B-TECH\n\n◈━━━━━━━━━━━━━━━━◈\n│❒ OOPS! bot failed to show off: ${e.message} 😡 Try again! 😣\n◈━━━━━━━━━━━━━━━━◈`);
            }
        ...
        if (!superUser) {
            repondre(`𝐓𝐎𝐗𝐈𝐂-𝐌𝐃\n\n◈━━━━━━━━━━━━━━━━◈\n│❒ 🛑 Only owner can change alive message!\n◈━━━━━━━━━━━━━━━━◈`);
            return;
        }
